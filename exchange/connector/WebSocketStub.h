...
namespace close {
enum status { normal = 1000 };
}

namespace log {
enum level { all_levels, error_level };

enum elevel { all_errors };

enum alevel { all_access };
} // namespace log
...
public:
  ...
  // Set handlers
  template <typename Handler> void set_open_handler(Handler) {}

  template <typename Handler> void set_close_handler(Handler) {}

  template <typename Handler> void set_fail_handler(Handler) {}

  template <typename Handler> void set_message_handler(Handler) {}

  template <typename Handler> void set_tls_init_handler(Handler) {}
