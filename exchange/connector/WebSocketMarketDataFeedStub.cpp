...
bool WebSocketMarketDataFeed::start() {
  std::cout << "Mock WebSocket connection started for " << getExchangeName()
            << std::endl;
...
bool WebSocketMarketDataFeed::stop() {
  std::cout << "Mock WebSocket connection stopped for " << getExchangeName()
            << std::endl;
...
void WebSocketMarketDataFeed::onMessage(websocketpp::connection_hdl hdl,
                                        message_ptr msg) {}
WebSocketMarketDataFeed::context_ptr
