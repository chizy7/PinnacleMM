...
public:
     ...
     */
    explicit InteractiveBrokersFixConnector(std::shared_ptr<utils::ApiCredentials> credentials);
    ...
    bool replaceOrder(const std::string& orderId, const pinnacle::Order& newOrder) override;
