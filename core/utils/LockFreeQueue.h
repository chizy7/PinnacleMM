...
public:
     ...
     * @return true if the element was enqueued successfully, false if the queue was full
     */
     ...
     * @return true if an element was dequeued successfully, false if the queue was empty
     */
