...
public:
    ...
    // Numeric validation
    static ValidationResult validateDouble(const std::string& input, 
                                         double minValue = -std::numeric_limits<double>::max(),
                                         double maxValue = std::numeric_limits<double>::max());
    
    static ValidationResult validateInteger(const std::string& input, 
...
private:
    // Helper functions
    static bool containsOnlyAllowedChars(const std::string& input, const std::string& allowed);
