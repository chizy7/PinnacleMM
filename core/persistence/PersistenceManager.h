...
public:
    ...
    std::shared_ptr<snapshot::SnapshotManager> getSnapshotManager(const std::string& symbol);
...
private:
    ...
    std::unordered_map<std::string, std::shared_ptr<snapshot::SnapshotManager>> m_snapshotManagers;
