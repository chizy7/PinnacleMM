...
public:
    ...
    static JournalEntry createOrderExecutedEntry(const std::string& orderId, double quantity);
    
    // Create entry for market order execution
    static JournalEntry createMarketOrderEntry(OrderSide side, double quantity, 
